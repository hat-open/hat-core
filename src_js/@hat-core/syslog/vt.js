...
import * as table from '@hat-core/syslog/common/table';
import * as menu from '@hat-core/syslog/common/menu';
import * as details from '@hat-core/syslog/common/details';
import * as filter from '@hat-core/syslog/common/filter';
